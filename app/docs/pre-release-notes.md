...
✅ **OC-7724: Fixed an issue with container sub-schedule not closing when all jobs fail.
...
✅ **OC-7766: Fixed Number of Runs defaulting to "false" on Restart Offset.

✅ **OC-7763: Fixed an issue with preserving instance property name casing for RPA/ACS jobs.
