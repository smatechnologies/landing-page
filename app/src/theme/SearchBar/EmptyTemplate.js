    ...
    return `<span class="${styles.noResults}">
        ...
        <div class="search-no-results-help">
          ...
          <p class="search-no-results-links">
            <a href="https://community.smatechnologies.com/" target="_blank" rel="noopener noreferrer">Community Forum</a>
            &nbsp;·&nbsp;
            <a href="https://smatech2.my.site.com/SMASupportPortal" target="_blank" rel="noopener noreferrer">Support Portal</a>
          </p>
        </div>
      </span>`;
}
